...
export function AdvocateQuickToolkit() {
  ...
  return (
    <div className="mt-14 sm:mt-20 pt-10 border-t border-white/10 select-none">
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
          ...
          <h3 className="font-anton text-2xl sm:text-3xl lg:text-4xl text-white uppercase tracking-tight">
            IPC → BNS Rapid Concordance & Courtroom Precedent
          </h3>
          <p className="text-xs sm:text-sm text-[#a9a49a] font-sans mt-1">
        ...
        <Link
          href="/bns"
          className="inline-flex items-center gap-2 px-4 py-2.5 bg-white/10 hover:bg-[#D4AF37] hover:text-black text-white text-xs font-mono font-bold uppercase tracking-wider rounded-xs border border-white/15 transition-all self-start md:self-auto cursor-pointer"
        >
        ...
        {popularPills.map((pill) => {
          ...
          return (
            <button
              ...
              className={`px-3 py-1 text-xs font-mono font-bold rounded-xs transition-all flex-shrink-0 cursor-pointer border ${
                isSelected
      ...
      <div className="p-6 sm:p-8 bg-gradient-to-br from-[#12141F] to-[#0D0F17] border border-[#D4AF37]/30 rounded-sm shadow-2xl space-y-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
          
          {/* Left Column: Old vs New Statute Box */}
          <div className="lg:col-span-5 space-y-4">
            <div className="flex items-center justify-between p-4 bg-black/60 border border-white/10 rounded-xs">
              <div>
                <span className="text-[10px] font-mono text-white/50 uppercase block">
                  Colonial Statute
                </span>
                <span className="font-anton text-2xl sm:text-3xl text-[#E50914] tracking-tight">
                  {activeStatute.old}
                </span>
              </div>
              ...
              <div className="text-right">
                ...
                <span className="font-anton text-2xl sm:text-3xl text-emerald-400 tracking-tight">
          ...
          <div className="lg:col-span-7 space-y-4 lg:border-l lg:border-white/10 lg:pl-6">
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
              <button
                onClick={handleCopy}
                className="px-4 py-2 bg-white/10 hover:bg-white/20 text-white text-xs font-mono font-bold uppercase rounded-xs transition-all border border-white/15 flex items-center gap-1.5 cursor-pointer"
              >
              ...
              <Link
                href="/browse"
                className="text-xs font-mono font-bold text-[#D4AF37] hover:underline flex items-center gap-1"
              >
